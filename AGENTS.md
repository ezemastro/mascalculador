...
> **Auth hormigon**: idéntico a viga-continua, cookie `hc_session`, API en puerto `5177` (dev). El primer usuario del server queda admin (endpoint `/api/admin/users` + pantalla Admin).
